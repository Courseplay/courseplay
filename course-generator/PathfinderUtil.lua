...
function PathfinderUtil.VehicleData:createSquare(size)
	...
	courseplay.debugFormat(courseplay.DBG_PATHFINDER, 'Collision square size for jump point is %.1f x %.1f m', size, size)
...
function PathfinderUtil.startPathfinding(start, goal, context, constraints, allowReverse, mustBeAccurate)
    ...
    --local pathfinder = JumpPointSearch(100, 40000, mustBeAccurate)
...
function PathfinderUtil.ensureHelperNode()
