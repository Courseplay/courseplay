...
function courseplay.hud:setFieldWorkAIDriverContent(vehicle)
	...
	self:addRowButton(vehicle,'Setting:returnToFirstPoint:toggle', 1, 5, 1 ):setOnlyCallLocal()
	...
	self:addRowButton(vehicle,'Setting:symmetricLaneChange:toggle', 8, 2, 1 ):setOnlyCallLocal();
