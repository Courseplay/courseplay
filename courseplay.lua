...
local function setGlobalData()
	...
	[14]={name='self.cp.headland.numLanes',dataFormat='Int'},
	[15]={name='self.cp.headland.turnType',dataFormat='Int'},
    [16]={name='self.cp.hasUnloadingRefillingCourse	',dataFormat='Bool'},
	[17]={name='self.cp.isDriving',dataFormat='Bool'},
	[28]={name='self.cp.hud.openWithMouse',dataFormat='Bool'},
	[29]={name='self.cp.tipperOffset',dataFormat='Float'},
	[20]={name='self.cp.tipperHasCover',dataFormat='Bool'},
	[21]={name='self.cp.workWidth',dataFormat='Float'},
	[22]={name='self.cp.turnDiameterAutoMode',dataFormat='Bool'},
	[23]={name='self.cp.turnDiameter',dataFormat='Float'},
	[24]={name='self.cp.coursePlayerNum',dataFormat='Int'}, --??
	[25]={name='self.cp.laneOffset',dataFormat='Float'},
	[26]={name='self.cp.loadUnloadOffsetX',dataFormat='Float'},
	[27]={name='self.cp.loadUnloadOffsetZ',dataFormat='Float'},
	[38]={name='self.cp.hud.currentPage',dataFormat='Int'},
	[39]={name='self.cp.waypointIndex',dataFormat='Int'},
	[30]={name='self.cp.isRecording',dataFormat='Bool'},
	[31]={name='self.cp.recordingIsPaused',dataFormat='Bool'},
	[32]={name='self.cp.searchCombineAutomatically',dataFormat='Bool'},
	[33]={name='self.cp.waitTime',dataFormat='Int'},
	[34]={name='self.cp.multiTools',dataFormat='Int'},
	[35]={name='self.cp.alignment.enabled',dataFormat='Bool'},
	[36]={name='self.cp.hasSowingMachine',dataFormat='Bool'},
	[37]={name='self.cp.generationPosition.fieldNum',dataFormat='Int'},
	[48]={name='self.cp.generationPosition.hasSavedPosition',dataFormat='Bool'},
	[49]={name='self.cp.generationPosition.x',dataFormat='Float'},
	[40]={name='self.cp.generationPosition.z',dataFormat='Float'}
	}
