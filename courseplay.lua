...
local function setGlobalData()
	...
	[14]={name='self.cp.hasValidCourseGenerationData',dataFormat='Bool'},
	[15]={name='self.cp.headland.numLanes',dataFormat='Int'},
	[16]={name='self.cp.headland.turnType',dataFormat='Int'},
    [17]={name='self.cp.hasUnloadingRefillingCourse	',dataFormat='Bool'},
	[18]={name='self.cp.isDriving',dataFormat='Bool'},
	[29]={name='self.cp.hud.openWithMouse',dataFormat='Bool'},
	[20]={name='self.cp.tipperOffset',dataFormat='Float'},
	[21]={name='self.cp.tipperHasCover',dataFormat='Bool'},
	[22]={name='self.cp.workWidth',dataFormat='Float'},
	[23]={name='self.cp.turnDiameterAutoMode',dataFormat='Bool'},
	[24]={name='self.cp.turnDiameter',dataFormat='Float'},
	[25]={name='self.cp.coursePlayerNum',dataFormat='Int'}, --??
	[26]={name='self.cp.laneOffset',dataFormat='Float'},
	[27]={name='self.cp.loadUnloadOffsetX',dataFormat='Float'},
	[28]={name='self.cp.loadUnloadOffsetZ',dataFormat='Float'},
	[39]={name='self.cp.hud.currentPage',dataFormat='Int'},
	[30]={name='self.cp.waypointIndex',dataFormat='Int'},
	[31]={name='self.cp.isRecording',dataFormat='Bool'},
	[32]={name='self.cp.recordingIsPaused',dataFormat='Bool'},
	[33]={name='self.cp.searchCombineAutomatically',dataFormat='Bool'},
	[34]={name='self.cp.waitTime',dataFormat='Int'},
	...
	[49]={name='self.cp.generationPosition.hasSavedPosition',dataFormat='Bool'},
